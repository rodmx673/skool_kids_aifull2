      ...
      <Sidebar>
        ...
        <SidebarContent>
          <SidebarMenu>
            ...
            <SidebarMenuItem>
              <Link href="/dashboard/gestion-escolar?tab=docente">
                <SidebarMenuButton tooltip="Docentes" isActive={pathname.startsWith('/dashboard/gestion-escolar?tab=docente')}>
                  <BookUser />
                  <span>Docentes</span>
                </SidebarMenuButton>
              </Link>
             ...
             <SidebarMenuItem>
              <Link href="/dashboard/administrativo/asistencias">
                <SidebarMenuButton tooltip="Control de Asistencia" isActive={pathname.startsWith('/dashboard/administrativo/asistencias')}>
                  <CalendarCheck />
