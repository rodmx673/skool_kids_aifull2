...
export default function PadreDashboardLayout({
  children,
}: {
  ...
  const isStudentMirrorView = pathname.includes('/dashboard/padre/hijos/');
  ...
  // If we are in the student mirror view, we only render the children,
  // which will be the student-specific layout.
  if (isStudentMirrorView) {
    return <>{children}</>;
  }
      ...
      <Sidebar>
        <SidebarHeader>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-sidebar-foreground tracking-tight">Portal Padres</h2>
          </div>
        </SidebarHeader>
        <SidebarContent>
          <SidebarMenu>
            <SidebarMenuItem>
              <Link href="/dashboard/padre/hijos">
                <SidebarMenuButton tooltip="Mis Hijos" isActive={pathname.startsWith('/dashboard/padre/hijos')}>
                  <Users />
                  <span>Mis Hijos</span>
                </SidebarMenuButton>
              </Link>
            ...
            <SidebarMenuItem>
              <Link href="/dashboard/padre/comunicados">
                <SidebarMenuButton tooltip="Comunicados" isActive={pathname.startsWith('/dashboard/padre/comunicados')}>
                  <Bell />
             ...
             <SidebarMenuItem>
              <Link href="/dashboard/padre/mensajeria">
                <SidebarMenuButton tooltip="Mensajería" isActive={pathname.startsWith('/dashboard/padre/mensajeria')}>
                  <MessageCircle />
            ...
            <SidebarMenuItem>
              <Link href="/dashboard/padre/calendario">
                <SidebarMenuButton tooltip="Calendario" isActive={pathname.startsWith('/dashboard/padre/calendario')}>
                  <Calendar />
        ...
        <header className="sticky top-0 z-30 flex h-14 items-center gap-4 border-b bg-background/95 backdrop-blur-sm px-4 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6 py-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                 <Avatar>
                  <AvatarImage src={currentUser.profilePictureUrl || `https://picsum.photos/seed/${currentUser.id}/40/40`} alt="User Avatar" data-ai-hint="parent face" />
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <Link href="/dashboard/padre/settings">
                <DropdownMenuItem>
